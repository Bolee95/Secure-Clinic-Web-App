...
class WaitingListForPacientComponent extends React.Component {
    ...
    getWaitingList() {
        ...
        axios({ method: 'GET', url: '/shared/getWaitingList', headers: { 'Identity_name': 'admin' }, params: { 'hospitalCode': hospitalCode, 'ordinationCode': ordinationCode, 'serviceCode': serviceCode }})
        .then(response => {
            let title;
            let pacients = [];   
